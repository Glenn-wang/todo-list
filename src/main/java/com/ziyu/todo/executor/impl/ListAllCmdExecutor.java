...
public class ListAllCmdExecutor implements CmdExecutor {
    ...
    private TodoDTO createTodoDTO(TodoDO todoDO) {
        return new TodoDTO(todoDO.getId(), todoDO.getContent(), todoDO.getStatus());
    }
}
